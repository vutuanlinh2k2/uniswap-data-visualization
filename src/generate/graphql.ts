...
export type ExampleTokensQueryQueryVariables = Exact<{ [key: string]: never }>

export type ExampleTokensQueryQuery = {
    __typename?: "Query"
    tokens: Array<{ __typename?: "Token"; id: string }>
}

export const ExampleTokensQueryDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "ExampleTokensQuery" },
            selectionSet: {
                kind: "SelectionSet",
                selections: [
                    {
...
} as unknown as DocumentNode<ExampleTokensQueryQuery, ExampleTokensQueryQueryVariables>
