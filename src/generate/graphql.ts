...
export type GetCurrentEthPriceQuery = {
  __typename?: "Query"
  bundles: Array<{ __typename?: "Bundle"; id: string; ethPriceUSD: any }>
}

export type GetTokensDataQueryVariables = Exact<{ [key: string]: never }>

export type GetTokensDataQuery = {
  __typename?: "Query"
  tokens: Array<{
    __typename?: "Token"
    id: string
...
export type GetTransactionsDataQuery = {
  __typename?: "Query"
  transactions: Array<{
    __typename?: "Transaction"
    id: string
...
export const GetCurrentEthPriceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getCurrentEthPrice" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "ethPriceUSD" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<GetCurrentEthPriceQuery, GetCurrentEthPriceQueryVariables>
export const GetTokensDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getTokensData" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                ...
                value: { kind: "EnumValue", value: "totalValueLockedUSD" },
              },
              {
                kind: "Argument",
              ...
              {
                kind: "Argument",
                name: { kind: "Name", value: "subgraphError" },
                value: { kind: "EnumValue", value: "allow" },
              },
            ],
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "totalValueLockedUSD" } },
                { kind: "Field", name: { kind: "Name", value: "derivedETH" } },
              ],
            },
          },
        ],
...
} as unknown as DocumentNode<GetTokensDataQuery, GetTokensDataQueryVariables>
export const GetTransactionsDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
                ...
                { kind: "Field", name: { kind: "Name", value: "timestamp" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "amount1" } },
...
} as unknown as DocumentNode<GetTransactionsDataQuery, GetTransactionsDataQueryVariables>
